...
# ============================================================
# Escalas Deploy - Limpeza do Ambiente
# ============================================================
#
# Responsável por preparar o ambiente antes de uma nova
# execução do instalador.
#
# Caso seja encontrada uma instalação anterior, este arquivo
# decide como ela será tratada conforme o modo de execução:
#
# Desenvolvimento:
#   - remove containers antigos;
#   - remove dados do PostgreSQL;
#   - permite executar o instalador repetidas vezes.
#
# Produção:
#   - permite atualizar a instalação existente; ou
#   - reinstalar completamente o ambiente mediante confirmação.
#
# ============================================================
...
cleanup_production_mode() {
    ...
    case "$opcao" in
        1)
            log "Usuário escolheu atualizar a instalação existente."
            ;;
        2)
...
cleanup_reinstall() {
    ...
    log "Removendo a instalação anterior."
    ...
    if [ -d "$APP_DIR/postgres/data" ]; then
        log "Removendo dados anteriores do PostgreSQL..."
        rm -rf "$APP_DIR/postgres/data"/*
    fi

    log "Ambiente preparado para uma nova instalação."
}